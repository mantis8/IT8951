...
- `BufferSize`  
The IT8951 instance statically allocates two uint16_t buffers of size `BufferSize`. This size - 2 (preamble + dummy word) limits the amount of data which can be sent in one command to the IT8951. 
